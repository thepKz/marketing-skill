...
const useCases = {
  ...
  menu: {
    vi: { title: 'Menu & food visual system', description: 'Biến một món ăn hoặc ảnh món có sẵn thành menu có logic: định vị, nhóm món, hierarchy, giá, wireframe và prompt chụp.', deliverables: ['Menu direction options', 'Information hierarchy & pricing', 'Photo / illustration shot list', 'Print, QR và social crops'], request: 'Dùng $marketing-minthep cho món bún bò trong ảnh đính kèm. Hãy nghiên cứu bối cảnh quán và khách văn phòng, đề xuất 3 hướng menu (hiện đại, truyền thống, premium), wireframe từng hướng, thứ tự món, cách đặt giá, palette, shot list và prompt hình ảnh. Trả về file Markdown.' },
