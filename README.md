...
```
marketing-minthep/
  SKILL.md                  entry point and router, 174 lines
  references/               61 topic files, each under 150 lines
    dossiers/               15 deep-craft dossiers + index
  data/                     27 lookup tables: image recipes, palettes, layout
